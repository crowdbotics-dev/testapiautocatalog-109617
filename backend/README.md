...
## Project Structure
    ...
    ├── testapiautocatalog_109617  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109617`
...
2. Clone this repo and `cd testapiautocatalog_109617`
